...
func (l *Logger) Fatalf(format string, args ...interface{}) {
	if fabric_logs.GetFabricLogger() != nil {
		fabric_logs.GetFabricLogger().Emergencyf(format, args...)
	} else {
...
func (l *Logger) Panicf(format string, args ...interface{}) {
	if fabric_logs.GetFabricLogger() != nil {
		fabric_logs.GetFabricLogger().Alertf(format, args...)
	} else {
		l.log(CRITICAL, &format, args...)
	}
...
func (l *Logger) Criticalf(format string, args ...interface{}) {
	if fabric_logs.GetFabricLogger() != nil {
		fabric_logs.GetFabricLogger().Criticalf(format, args...)
	} else {
		l.log(CRITICAL, &format, args...)
	}
...
func (l *Logger) Errorf(format string, args ...interface{}) {
	if fabric_logs.GetFabricLogger() != nil {
		fabric_logs.GetFabricLogger().Errorf(format, args)
	} else {
...
func (l *Logger) Warningf(format string, args ...interface{}) {
	if fabric_logs.GetFabricLogger() != nil {
		fabric_logs.GetFabricLogger().Warningf(format, args...)
	} else {
...
func (l *Logger) Noticef(format string, args ...interface{}) {
	if fabric_logs.GetFabricLogger() != nil {
		fabric_logs.GetFabricLogger().Noticef(format, args...)
	} else {
...
func (l *Logger) Infof(format string, args ...interface{}) {
	if fabric_logs.GetFabricLogger() != nil {
		fabric_logs.GetFabricLogger().Infof(format, args...)
	} else {
...
func (l *Logger) Debugf(format string, args ...interface{}) {
	if fabric_logs.GetFabricLogger() != nil {
		fabric_logs.GetFabricLogger().Debugf(format, args...)
	} else {
