...
type FileLedgerBlockStore interface {
	...
	WriteConfigBlockToSpecFile(block *cb.Block) error
	ReadConfigBlockFromSpecFile() (*cb.Block, error)
}
...
func (fl *FileLedger) DataDump(dumpReason int) error {
	return fl.blockStore.DataDump(dumpReason)
}

func (fl *FileLedger) WriteConfigBlockToSpecFile(block *cb.Block) error {
	return fl.blockStore.WriteConfigBlockToSpecFile(block)
}

func (fl *FileLedger) ReadConfigBlockFromSpecFile() (*cb.Block, error) {
	return fl.blockStore.ReadConfigBlockFromSpecFile()
}
