...
func (l *kvLedger) DataDump(dumpReason int) error {
	//now just dump blockfile
	//TODO Index,stateDB,historyDB
	return l.blockStore.DataDump(dumpReason)
}

func (l *kvLedger) WriteConfigBlockToSpecFile(block *common.Block) error {
	return l.blockStore.WriteConfigBlockToSpecFile(block)
}

func (l *kvLedger) ReadConfigBlockFromSpecFile() (*common.Block, error) {
	return l.blockStore.ReadConfigBlockFromSpecFile()
}
