...
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface) pb.Response {
	...
	b2 := &ComplexB{Name: "b2", Value: []byte("b2中午")}
	b22, _ := json.Marshal(b2)
	b1 := &ComplexB{Name: "b1", Value: b22}
	a := &ComplexA{Name: "a1", Value: "avalue", SByte: b1}
	aa, _ := json.Marshal(a)
	stub.PutState("complex struct", aa)
